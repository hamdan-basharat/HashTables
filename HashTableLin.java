    ...
    ***************************************************************************/
    public void insert(int n){
        ...
        if(((double)(this.getKeys()+1) / this.getSize()) > this.maxLoad)
            ...
            int x = n;
            boolean probe = true; //flag for linear probing
            while(probe == true){ //runs while the flag is true
                ...
                else{x++;} //linearly increases value to avoid collision on next attempt
            }
    ...
    public int insertSim(int n){ 
        ...
        if(((double)(this.getKeys()+1) / this.getSize()) > this.maxLoad)
            ...
            while(probe == true){ //runs while the flag is true
                ...
                else{x++; probes++;} //linearly increases value to avoid collision on next attempt
            }
            this.setKeys(this.getKeys()+1); //number of keys is updated
        }
